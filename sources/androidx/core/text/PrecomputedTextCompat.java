...
public class PrecomputedTextCompat implements Spannable {
    ...
    @IntRange(from = Connections.DURATION_INDEFINITE)
    public int getParagraphStart(@IntRange(from = Connections.DURATION_INDEFINITE) int i) {
    ...
    @IntRange(from = Connections.DURATION_INDEFINITE)
    public int getParagraphEnd(@IntRange(from = Connections.DURATION_INDEFINITE) int i) {
        Preconditions.checkArgumentInRange(i, 0, getParagraphCount(), "paraIndex");
        if (Build.VERSION.SDK_INT >= 28) {
    ...
    private int findParaIndex(@IntRange(from = Connections.DURATION_INDEFINITE) int i) {
        int i2 = 0;
        while (true) {
