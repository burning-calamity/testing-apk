...
public class ActivityCompat extends ContextCompat {
    ...
    public interface PermissionCompatDelegate {
        boolean onActivityResult(@NonNull Activity activity, @IntRange(from = Connections.DURATION_INDEFINITE) int i, int i2, @Nullable Intent intent);

        boolean requestPermissions(@NonNull Activity activity, @NonNull String[] strArr, @IntRange(from = Connections.DURATION_INDEFINITE) int i);
    }
    ...
    public static void requestPermissions(@NonNull final Activity activity, @NonNull final String[] strArr, @IntRange(from = Connections.DURATION_INDEFINITE) final int i) {
