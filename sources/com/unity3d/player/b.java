...
public final class b extends SSLSocketFactory {
    ...
    public static abstract class AbstractC0013b implements X509TrustManager {
    ...
    private b(AbstractC0013b[] abstractC0013bArr) throws NoSuchAlgorithmException, KeyManagementException {
        SSLContext sSLContext = SSLContext.getInstance("TLS");
        sSLContext.init(null, abstractC0013bArr, null);
    ...
    public static SSLSocketFactory a(AbstractC0013b abstractC0013b) {
        try {
            return abstractC0013b == null ? b() : new b(new AbstractC0013b[]{abstractC0013b});
        } catch (Exception e2) {
