...
public final class zzjh implements zzje {
    ...
    static {
        ...
        zzb = zzctVar.zza("measurement.config.cache_time", 86400000L);
        ...
        zzm = zzctVar.zza("measurement.monitoring.sample_period_millis", 86400000L);
        ...
        zzs = zzctVar.zza("measurement.upload.stale_data_deletion_interval", 86400000L);
