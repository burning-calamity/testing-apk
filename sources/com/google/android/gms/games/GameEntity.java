...
public final class GameEntity extends GamesDowngradeableSafeParcel implements Game {
    ...
    @SafeParcelable.Field(getter = "isMuted", id = MotionEventCompat.AXIS_WHEEL)
    private final boolean zzaf;

    @SafeParcelable.Field(getter = "isIdentitySharingConfirmed", id = MotionEventCompat.AXIS_GAS)
    private final boolean zzag;

    @SafeParcelable.Field(getter = "areSnapshotsEnabled", id = MotionEventCompat.AXIS_BRAKE)
    private final boolean zzah;

    @SafeParcelable.Field(getter = "getThemeColor", id = MotionEventCompat.AXIS_DISTANCE)
    ...
    @SafeParcelable.Field(getter = "getInstancePackageName", id = MotionEventCompat.AXIS_RX)
