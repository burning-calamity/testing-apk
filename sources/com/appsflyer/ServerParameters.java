...
public interface ServerParameters {
    ...
    public static final String DDL_NET_LATENCY = "ddl_net_latency";
    ...
    public static final String FIRST_LAUNCH_COLLECTION = "fg_to_first_launch_collection_duration";
    public static final String FIRST_LAUNCH_NETWORKING = "first_launch_collection_net_latency";
    public static final String FOREGROUND = "init_to_fg_duration";
    public static final String GCD_NETWORKING = "gcd_net_latency";
